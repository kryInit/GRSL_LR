...
\input{src_pre/img/experiment-data}
\input{src_pre/img/observed-seismic-data}

\input{src_pre/img/experiment-results-pure}
\input{src_pre/img/experiment-results-noisy}
\input{src_pre/img/ssim-graph}
